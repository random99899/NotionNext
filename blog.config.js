...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'R4nd0m99', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的JNUer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-liart-one.vercel.app', // 网站地址
  ...
  // 漂浮线段特效
  NEST: process.env.NEXT_PUBLIC_NEST || false, // 开关，没用
  
  // 欢迎语打字效果,Hexo,Matery主题支持, 英文逗号隔开多个欢迎语。
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS ||
    'Hi，我是一位JNUer, 欢迎来到我的博客🎉',
